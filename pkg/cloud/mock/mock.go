...
func convertAndInsertAlphaForwardingRule(key *meta.Key, obj gceObject, mRules map[meta.Key]*cloud.MockForwardingRulesObj, version meta.Version, projectID string) (bool, error) {
	...
	if fwdRule.SelfLink == "" {
		fwdRule.SelfLink = cloud.SelfLink(meta.APIGroupCompute, version, projectID, "forwardingRules", key)
	}
...
func convertAndInsertAlphaAddress(key *meta.Key, obj gceObject, mAddrs map[meta.Key]*cloud.MockAddressesObj, version meta.Version, projectID string, addressAttrs AddressAttributes) (bool, error) {
	...
	addr.Name = key.Name
	if addr.SelfLink == "" {
		addr.SelfLink = cloud.SelfLink(meta.APIGroupCompute, version, projectID, "addresses", key)
	}
...
func UpdateFirewallHook(ctx context.Context, key *meta.Key, obj *ga.Firewall, m *cloud.MockFirewalls) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionGA, projectID, "firewalls", key)
...
func UpdateAlphaFirewallHook(ctx context.Context, key *meta.Key, obj *alpha.Firewall, m *cloud.MockAlphaFirewalls) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionAlpha, projectID, "firewalls", key)
...
func UpdateBetaFirewallHook(ctx context.Context, key *meta.Key, obj *beta.Firewall, m *cloud.MockBetaFirewalls) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionBeta, projectID, "firewalls", key)
...
func UpdateHealthCheckHook(ctx context.Context, key *meta.Key, obj *ga.HealthCheck, m *cloud.MockHealthChecks) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionGA, projectID, "healthChecks", key)
...
func UpdateAlphaHealthCheckHook(ctx context.Context, key *meta.Key, obj *alpha.HealthCheck, m *cloud.MockAlphaHealthChecks) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionAlpha, projectID, "healthChecks", key)
...
func UpdateBetaHealthCheckHook(ctx context.Context, key *meta.Key, obj *beta.HealthCheck, m *cloud.MockBetaHealthChecks) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionBeta, projectID, "healthChecks", key)
...
func UpdateRegionBackendServiceHook(ctx context.Context, key *meta.Key, obj *ga.BackendService, m *cloud.MockRegionBackendServices) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionGA, projectID, "backendServices", key)
...
func UpdateAlphaRegionBackendServiceHook(ctx context.Context, key *meta.Key, obj *alpha.BackendService, m *cloud.MockAlphaRegionBackendServices) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionAlpha, projectID, "backendServices", key)
...
func UpdateBetaBackendServiceHook(ctx context.Context, key *meta.Key, obj *beta.BackendService, m *cloud.MockBetaBackendServices) error {
	...
	obj.Name = key.Name
	projectID := m.ProjectRouter.ProjectID(ctx, "beta", "backendServices")
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionBeta, projectID, "backendServices", key)
...
func UpdateURLMapHook(ctx context.Context, key *meta.Key, obj *ga.UrlMap, m *cloud.MockUrlMaps) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionGA, projectID, "urlMaps", key)
...
func UpdateAlphaURLMapHook(ctx context.Context, key *meta.Key, obj *alpha.UrlMap, m *cloud.MockAlphaUrlMaps) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionAlpha, projectID, "urlMaps", key)
...
func UpdateBetaURLMapHook(ctx context.Context, key *meta.Key, obj *beta.UrlMap, m *cloud.MockBetaUrlMaps) error {
	...
	obj.SelfLink = cloud.SelfLink(meta.APIGroupCompute, meta.VersionBeta, projectID, "urlMaps", key)
